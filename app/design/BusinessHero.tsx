...
const scenes = ['cafe', 'hotel', 'bank', 'meeting', 'sea'];
...
const messages: Record<Language, string[]> = {
  ru: ['ESX для бизнеса', 'Кофейня|Гостиница|Банк|Бизнес-встреча|У моря', 'Кофе сближает. ESX помогает общаться.|Гостеприимство начинается с понимания.|Важные вопросы. Понятный разговор.|Разные страны. Общие идеи.|Хороший вечер начинается с общения.', 'Один QR-код — и вы в личном чате. Общайтесь с гостями, клиентами и партнёрами через ESX.', 'Остановить смену баннеров', 'Продолжить смену баннеров'],
  en: ['ESX for business', 'Coffee shop|Hotel|Bank|Business meeting|By the sea', 'Coffee connects. ESX keeps you talking.|Hospitality starts with understanding.|Important questions. Clear conversations.|Different countries. Shared ideas.|A good evening starts with a conversation.', 'One QR code opens a private chat. Connect with guests, customers and partners through ESX.', 'Pause banners', 'Play banners'],
  ko: ['비즈니스를 위한 ESX', '카페|호텔|은행|비즈니스 미팅|바닷가', '커피로 가까워지고, ESX로 소통하세요.|이해에서 시작되는 환대.|중요한 질문, 편안한 대화.|나라는 달라도 아이디어는 함께.|좋은 저녁은 대화에서 시작됩니다.', 'QR 코드 하나로 개인 채팅을 시작하세요. ESX로 손님, 고객, 파트너와 소통하세요.', '배너 일시 정지', '배너 재생'],
  zh: ['商务 ESX', '咖啡店|酒店|银行|商务会议|海边', '咖啡拉近距离，ESX连接对话。|待客之道始于理解。|重要问题，清晰沟通。|不同国家，共同创意。|美好夜晚，从交流开始。', '一个二维码即可开启私密聊天。通过ESX与宾客、客户和合作伙伴交流。', '暂停轮播', '继续轮播'],
  tr: ['İş dünyası için ESX', 'Kafe|Otel|Banka|İş toplantısı|Deniz kenarında', 'Kahve yakınlaştırır. ESX iletişim kurar.|Misafirperverlik anlayışla başlar.|Önemli sorular. Açık konuşmalar.|Farklı ülkeler. Ortak fikirler.|Güzel bir akşam sohbetle başlar.', 'Tek bir QR kodla özel sohbet başlatın. ESX ile misafirleriniz, müşterileriniz ve ortaklarınızla iletişim kurun.', 'Bannerları duraklat', 'Bannerları oynat'],
  vi: ['ESX cho doanh nghiệp', 'Quán cà phê|Khách sạn|Ngân hàng|Cuộc họp kinh doanh|Bên biển', 'Cà phê gắn kết. ESX kết nối trò chuyện.|Hiếu khách bắt đầu từ sự thấu hiểu.|Câu hỏi quan trọng. Trao đổi rõ ràng.|Khác quốc gia. Chung ý tưởng.|Buổi tối đẹp bắt đầu bằng trò chuyện.', 'Một mã QR mở cuộc trò chuyện riêng. Kết nối khách hàng và đối tác qua ESX.', 'Tạm dừng biểu ngữ', 'Tiếp tục biểu ngữ'],
  km: ['ESX សម្រាប់អាជីវកម្ម', 'ហាងកាហ្វេ|សណ្ឋាគារ|ធនាគារ|កិច្ចប្រជុំអាជីវកម្ម|មាត់សមុទ្រ', 'កាហ្វេនាំមនុស្សជិតស្និទ្ធ។ ESX ជួយទំនាក់ទំនង។|បដិសណ្ឋារកិច្ចចាប់ផ្តើមពីការយល់គ្នា។|សំណួរសំខាន់។ ការសន្ទនាច្បាស់លាស់។|ប្រទេសផ្សេងគ្នា។ គំនិតរួមគ្នា។|រាត្រីល្អចាប់ផ្តើមពីការសន្ទនា។', 'កូដ QR មួយបើកការជជែកឯកជន។ ទាក់ទងភ្ញៀវ អតិថិជន និងដៃគូតាម ESX។', 'ផ្អាកបដា', 'បន្តបដា'],
  kk: ['Бизнеске арналған ESX', 'Кофехана|Қонақүй|Банк|Іскерлік кездесу|Теңіз жағасында', 'Кофе жақындастырады. ESX тілдестіреді.|Қонақжайлық түсіністіктен басталады.|Маңызды сұрақтар. Түсінікті әңгіме.|Әртүрлі елдер. Ортақ идеялар.|Жақсы кеш әңгімеден басталады.', 'Бір QR код жеке чат ашады. ESX арқылы қонақтармен, клиенттермен және серіктестермен сөйлесіңіз.', 'Баннерлерді тоқтату', 'Баннерлерді жалғастыру'],
};
